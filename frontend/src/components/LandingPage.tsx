export default function LandingPage() {
  return (
    <>
      <section className="hero is-fullheight site-hero">
        <div className="hero-body has-text-centered">
          <div className="container">
            ...
            <a className="button is-light is-medium mt-4 cta" href="#services">Explore Our Services</a>
          </div>
        </div>
      </section>
      ...
      <section className="section has-background-primary-light">
        <div className="container has-text-centered">
          ...
          <a className="button is-primary is-medium mt-3 cta" href="#contact">Contact Us</a>
        </div>
      </section>
    </>
